...
an inequality with optimal constant (with equality for round sphere) was obtained bu Marcel Berger and Jerry Kazdan \cite{berger-kazdan}. 
...
As a corollary form \ref{thm:sys<width++} and \ref{thm:width<vol} we get the so called \index{systolic inequality!Gromov's systolic inequality}\emph{Gromov's systolic inequality}:
