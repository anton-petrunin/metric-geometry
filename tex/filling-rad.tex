...
Now we are ready to give a proof of \ref{thm:width<volpro};
in fact we will show that we can take $c_n=n$.
...
can not be smaller than $c_n=\pi/\sqrt[n]{v_n}$ which grows as $\sqrt n$.
