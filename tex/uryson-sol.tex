...
Choose a separable space $\spc{X}$ that has an infinite number of geodesics between a pair of points with given distance between them;
...
\parit{\ref{SHORT.ex:homogeneous:hilbert}.} The Hilbert space $\ell^2$ is finite set homogeneous, but not compact set homogeneous, nor countable homogeneous.
