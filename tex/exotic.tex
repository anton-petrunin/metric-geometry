...
The following example was constructed by Michael Davis in \cite{davis-noneuclidean}.
...
Fredric Ancel, 
Michael Davis,
and Craig Guilbault in \cite{ADG};
...
several of which are discussed in the survey \cite{davis-survey} by Michael Davis.
