...
\begin{subthm}{cube-1} A cube complex $Q$ equipped with $\ell^1$-metric is \index{median space}\emph{median}.
 The latter means that for any three points $x,y,z$ there is a {}\emph{unique} point $m$ (it is called the \index{median}\emph{median} of $x$, $y$, and $z$) that lies on {}\emph{some} geodesics $[xy]$, $[xz]$ and $[yz]$.
\end{subthm}
\end{thm}
