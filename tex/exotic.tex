...
%the same dimension.
%???Why should all the cubes have the same dimension?? V. Is it better? A.???
...
The following statement can extracted from a paper of Brian Bowditch~\cite{bowditch-2020}.
...
\begin{thm}{Exercise}\label{ex:cube-infty=>cube-2} Prove the implication \ref{SHORT.cube-infty}$\Rightarrow$\ref{SHORT.cube-2} in the theorem.
\end{thm}
