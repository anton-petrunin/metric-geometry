...
\parbf{\ref{ex:two-point-homogeneous}.}
Let $x_\omega$, $y_\omega$, $x_\omega'$, and $y_\omega'$ be points in the small ultrapower of $\spc{X}$ such that $\dist{x_\omega}{y_\omega}{}\z=\dist{x'_\omega}{y'_\omega}{}$.

We can choose sequences $x_n$, $y_n$, $x'_n$, and $y'_n$ in  $\spc{X}$ that converge to the corresponding points as $n\to\omega$.
Moreover, since $\spc{X}$ is a length space, we can assume that
$\dist{x_n}{y_n}{}\z=\dist{x'_n}{y'_n}{}$
for every $n$.

By two-point homogeneity, there is an isometry $f_n$ of $\spc{X}$ that maps $x_n\mapsto x'_n$ and $y_n\mapsto y'_n$.
Pass to the ultralimit $f_n\to f_\omega$.
Note that $f_\omega$ is distance-preserving and $f_n^{-1}\to f_\omega^{-1}$; hence $f_\omega$ is onto.

\parit{Comments.}
It is instructive to check that the length assumption is essential.

It seems to be open whether a small ultrapower of a three-point homogeneous length space is necessarily three-point homogeneous.
