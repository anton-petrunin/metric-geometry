...
Let us identify $\spc{X}$ with nonnegative integers.
...
Show and use that the spaces $\spc{X}^\omega$ and $(\spc{X}^\omega)^\omega$ have discrete metric and both have cardinality at most continuum.
