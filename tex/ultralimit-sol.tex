...
\parbf{\ref{ex:ultraT}.}
Consider a product of an infinite sequence of closed intervals.

\parit{Remark.}
Such examples with different asymptotic cones exist even for spaces with cocompact isometric action \cite{thomas-velickovic}.
