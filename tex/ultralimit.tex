...
Use ultralimits to give a shorter proof of \ref{GH-2}.
\end{thm}
...
Given a nonprincipal ultrafilter $\omega$, construct an ultrafilter $\omega'$ such that 
\[\spc{X}^{\omega'}\iso(\spc{X}^\omega)^\omega\]
