...
If $\lambda_n\to 0$ as $n\to\omega$, then the metric component of $p_\omega$ in $\spc{X}_\omega$ is called \emph{$\omega$-tangent space} at $p$ and denoted by $\T_p^\omega\spc{X}$.\label{page:ultratangent space}
