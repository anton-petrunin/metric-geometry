...
More precisely, \textit{for any compact Hausdorff space $\spc{X}$ 
...
It follows that $\dist{x_\omega}{y_\omega}{}\ge \eps$ --- a contradiction.
\qeds
...
Applying \ref{lem:mid>geod}, we get the statement.
\qeds
...
The obtained metric component $\spc{Z}=(\spc{X}_\omega)_{p_\omega}$ with marked $p_\omega$ is also called the \index{pointed ultralimi}\emph{pointed $\omega$-limit} of $(\spc{X}_n,p_n)$.
