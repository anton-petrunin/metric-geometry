...
To see this look at the injective envelops of two 4-point metric spaces shown on the diagram and observe that the Gromov--Hausdorff distance between the 4-point metrric spaces is 1, while the distance between their injective envelops approaches 2 as $s\to\infty$. 
...
By \ref{ex:non-contracting-map}, the compositions $f_\infty\circ g_\infty\:\spc{Y}\to \spc{Y}$ and $g_\infty\z\circ f_\infty\:\spc{X}\to \spc{X}$ are isometrises.
