...
(Recall that a function $f\:\spc{X}\to\RR$ is proper if, for any compact set $K\subset \RR$, its inverse image $f^{-1}(K)$ is compact.)
\end{itemize}
...
Therefore \ref{lem:mid>geod} implies the following.
