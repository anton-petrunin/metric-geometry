...
Recall that the set 
\[S(p,r)=\set{x\in\spc{X}}{\dist{p}{x}{\spc{X}}=r}\]
...
Show that for any compact length-metric space $X$ there is number $\ell$ such that for any finite collection of points there is a point $z$ that lies of average distance $\ell$ from the collection;
