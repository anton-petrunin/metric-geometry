...
\parit{Proof.}
Choose $d\ge 0$.
Let us construct a separable metric space with $d$-extension property.
...
A construction of a separable metric space with extension property requires only minor changes.
...
The version of proposition for $d$-extension property can be proved along the same lines.
