...
You might wonder what is the topology of the Urysohn space.
...
The finite-set-homogeneous spaces include Euclidean spaces, hyperbolic spaces, standard spheres, and projective spaces all with standard metrics of constant curvatures.
In fact from \textit{Gleason--Yamabe theorem} it follows that these are the only examples of locally compact three-point-homogeneous length spaces; a proof was given by Jacques Tits \cite{tits}.
The answer might be the same for complete all-set-homogeneous length spaces.
