...
An extension $\spc{E}$ of a metric space $\spc{X}$ will be called its \index{injective envelop}\emph{injective envelop} if $\spc{E}$ is an injective space and there is no proper injective subspace of $\spc{E}$ that contains $\spc{X}$.
