...
\begin{subthm}{}
spaces in $\spc{Q}$ have uniformly bounded diameter; that is, there is $D\in\RR$ such that
\[\diam\spc{X}\le D\]
...
Let $\spc{Q}$ be a family of compact spaces with uniformly bounded diameter.
