...
Show that $|\Conv X-\Conv Y|_{\mathcal{H}(\RR^2)}<\eps$, where $\Conv X$ denoted a convex hull of $X$.
\end{subthm}
...
\emph{Gromov--Hausdorff convergence}\index{converges in the sense of Gromov--Hausdorff} to the (isometry classes of)
