...
\begin{thm}{Exercise}\label{ex:area-Haus}
Suppose a sequence of compact sets $K_1, K_2, \ldots \subset \RR^2$ converges to a compact set $K$ in the sense of Hausdorff.
Show that
\[\area K \ge \limsup_{n \to \infty} \area K_n.\]
