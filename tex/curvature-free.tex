...
The corresponding metric space $\spc{M}$ will be called \index{Riemannian!space}\emph{Riemannian space}
...
The identity in this proposition will be used to define \index{volume}\emph{volume of any dimension}.
...
A closed region in a Riemannian manifold bounded by hypersurface will be called \index{Riemannian!manifold with boundary}\emph{Riemannian manifold with boundary}.
