...
In this chapter we prove Reshetnyak's gluing theorem for $\CAT(0)$ spaces and apply it to a problem in billiards.
...
Suppose $\spc{U}$ is a complete length $\CAT(0)$ space and $A\subset \spc{U}$ is a closed subset.
...
The lecture \cite{burago-1998} gives a short survey on the subject.
...
It was show by Dmitri Burago and Sergei Ivanov \cite{burago-ivanov} that the number of collisions that may occur between $n$ identical balls $\mathbb{R}^3$ grows at least exponentially in $n$. 
