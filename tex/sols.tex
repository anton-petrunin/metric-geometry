...
Suppose that the geodesic are distinct.
In this case there are two points $p$ and $q$ on different geodesics such that $\dist{p}{x}{}=\dist{q}{x}{}$.
...
By Jensen inequality, it is sufficient to show that 
\[
...
therefore all intersections of the walls have $\eps$-wide corners for $\eps=2\cdot \arcsin\tfrac{r_1}{r_2}$.
