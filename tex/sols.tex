...
\[\varliminf_{n\to\infty} \vol \spc{M}_n\ge e^{-n\cdot \eps}\cdot\vol \spc{M}_\infty.\]
...
However a circle formed by a section of cylinder around its midpoint by a plane parallel to the base is a circle that can not be contracted in its small neighborhood.
